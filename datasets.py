...
class ImageNet256Features(DatasetFactory):  # the moments calculated by Stable Diffusion image encoder
    def __init__(self, path, cfg=False, p_uncond=None, train=False):
        super().__init__()
        ...
        # self.categorys = torch.arange(0, 1000).repeat_interleave(250)
...
class ImageNet(DatasetFactory):
    def __init__(self, path, resolution, random_crop=False, random_flip=True):
        ...
        self.categorys = torch.arange(0, 1000).repeat_interleave(50)
        self.categorys = torch.cat((self.categorys,torch.randint(0, 1000, (10000,)))) # append additional tensor in case 
